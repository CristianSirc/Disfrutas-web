	...
	<div class="page">
		...
		<nav>
			<ul class="topmenu">
				...
				<li><a class="active" href="frutas.php">Frutas</a></li>
		...
		<center>
			<p>¡Tienes muchas opciones para armar tu ensalada perfecta!</p>
		</center>
			<div class="box-a">
				<center>
				<img src="img/frutas-content1.jpg">
				<img src="img/frutas-content2.jpg">
				</center>
			</div>
		</div>
